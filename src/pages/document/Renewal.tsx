    ...
    const handleSaveRenewal = async (e: React.FormEvent) => {
        ...
        try {
            if (selectedDoc.rowIndex) {
                ...
                await Promise.all([
                    updateGoogleSheetCellsBySn('Documents', selectedDoc.sn, cellUpdates),
                ...
                console.log('Logged to Document Renewal sheet and updated Row');
        ...
        // Removed the re-fetch to improve speed. Local state is already improved.
        // await loadDocuments();
