...
const Layout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`
        fixed top-0 left-0 h-[100dvh] z-50 w-64 transform bg-white transition duration-300 ease-in-out lg:static lg:h-auto lg:translate-x-0 border-r border-gray-100
